...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/supabase.ts [app-ssr] (ecmascript)"); // ใช้ path ตามที่คุณตั้งไว้
...
function DashboardPage() {
    ...
    // --- ฟังก์ชันใหม่: สั่งจองห้อง ---
    const handleBooking = async (room)=>{
        // 1. ถามชื่อคนจอง (แบบง่ายๆ ก่อน)
        const userName = window.prompt(`คุณต้องการจองห้อง "${room.name}"\nกรุณากรอกชื่อของคุณ:`);
        if (!userName) return; // ถ้ากด cancel หรือไม่กรอกชื่อ ก็จบ
        try {
            // 2. บันทึกลงตาราง bookings
            const { error: bookingError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('bookings').insert({
                room_id: room.id,
                student_name: userName
            });
            if (bookingError) throw bookingError;
            // 3. อัปเดตสถานะห้องเป็น 'busy' (ไม่ว่าง)
            const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('classrooms').update({
                status: 'busy'
            }).eq('id', room.id);
            if (updateError) throw updateError;
            // 4. สำเร็จ! แจ้งเตือนและโหลดข้อมูลใหม่
            alert('✅ จองห้องสำเร็จเรียบร้อย!');
            fetchClassrooms(); // รีเฟรชหน้าจอให้เห็นสถานะล่าสุด
        } catch (error) {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: room.status === 'busy' ? 'ถูกจองแล้ว ❌' : 'จองห้องนี้ ✅'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/page.tsx",
                                                lineNumber: 109,
                                                columnNumber: 19
...
//# sourceMappingURL=src_7f55258b._.js.map